...
class ItemFactory{
	...
	public static function init(){
		...
		$records = [
			Item::RECORD_13 => Record::SOUND_RECORD_13,
			Item::RECORD_CAT => Record::SOUND_RECORD_CAT,
			Item::RECORD_BLOCKS => Record::SOUND_RECORD_BLOCKS,
			Item::RECORD_CHIRP => Record::SOUND_RECORD_CHIRP,
			Item::RECORD_FAR => Record::SOUND_RECORD_FAR,
			Item::RECORD_MALL => Record::SOUND_RECORD_MALL,
			Item::RECORD_MELLOHI => Record::SOUND_RECORD_MELLOHI,
			Item::RECORD_STAL => Record::SOUND_RECORD_STAL,
			Item::RECORD_STRAD => Record::SOUND_RECORD_STRAD,
			Item::RECORD_WARD => Record::SOUND_RECORD_WARD,
			Item::RECORD_11 => Record::SOUND_RECORD_11,
			Item::RECORD_WAIT => Record::SOUND_RECORD_WAIT,
			Item::RECORD_OTHERSIDE => Record::SOUND_RECORD_OTHERSIDE,
			Item::RECORD_5 => Record::SOUND_RECORD_5,
			Item::RECORD_PIGSTEP => Record::SOUND_RECORD_PIGSTEP,
			Item::RECORD_RELIC => Record::SOUND_RECORD_RELIC,
			Item::RECORD_CREATOR => Record::SOUND_RECORD_CREATOR,
			Item::RECORD_CREATOR_MUSIC_BOX => Record::SOUND_RECORD_CREATOR_MUSIC_BOX,
			Item::RECORD_PRECIPICE => Record::SOUND_RECORD_PRECIPICE,
			Item::RECORD_TEARS => Record::SOUND_RECORD_TEARS,
			Item::RECORD_LAVA_CHICKEN => Record::SOUND_RECORD_LAVA_CHICKEN,
			Item::RECORD_BOUNCE => Record::SOUND_RECORD_BOUNCE,
		];
